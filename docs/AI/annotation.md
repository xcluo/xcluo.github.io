...
- **MCP**：**M**odel **C**ontext **P**rotocol，模型上下文协议
...
- **PCM**：**P**ulse **C**ode **M**odulation，脉冲编码调制，一种数字音频编码格式
...
- **RoI**：**R**egion **o**f **I**nterest，感兴趣区域
...
- **VAD**：**V**oice **A**ctivity **D**etection，语音活动检测
